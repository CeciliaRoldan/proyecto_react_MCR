    ...
    <div style={{display:"flex",gap:"20px",flexWrap:"wrap"}} class="">
        {
            productos.map((producto)=>( 
                <div key={producto.id} class="border rounded" style={{borderColor:"grey",width:"400px"}}>
