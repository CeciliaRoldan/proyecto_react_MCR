    ...
    return (
        <Container>
            <div className='row mt-4 mb-4'>
                ...
                <div className='col-12 col-md-6'>               
                    <button onClick={() => agregarAlCarrito(producto)} class="btn btn-dark btn-lg float-end" aria-label={`Agregar ${producto.nombre} al carrito`}>
                        Agregar al Carrito
                    </button>
                </div> 
            </div>
            <div className='row mb-3'>
                ...
                <div className='col-12 col-md-6 col-lg-8 mt-4 mt-md-0 p-4'>
